...
from src.article import from_meca_manuscript, Article, AuthorReply, Review, RevisionRound
...
class ArticleTestCase(TestCase):
        ...
        for manuscript_name in INVALID_MANUSCRIPTS:
            with self.subTest(manuscript=manuscript_name):
                ...
                with self.assertRaises(ValueError):
                    from_meca_manuscript(manuscript, PUBLICATION_DATE, self.doi_generator)
    ...
    def test_parsing_valid_manuscripts(self) -> None:
        ...
        for manuscript_name, expected_result in ARTICLES.items():
            with self.subTest(manuscript=manuscript_name):
                manuscript = MANUSCRIPTS[manuscript_name]
                actual_result = from_meca_manuscript(manuscript, PUBLICATION_DATE, self.doi_generator)
